	...
	<form action="" method="post" class="form form-horizontal" id="my-form-submit">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
					<select name="type_pid" id="type_pid" class="select">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$field->type_name}}" placeholder="" id="type_name" name="type_name">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	$("#my-form-submit").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				url:"{{url('admin/subWebType/edit', ['id'=>$field->type_id])}}",//form提交数据的地址  data数据不用带了自动加上了
