...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="my-form-submit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$field->web_domain}}" placeholder="" id="web_domain" name="web_domain">
            </div>
        </div>
        <div class="row cl">
    ...
    $(function(){
        $("#my-form-submit").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    url:"{{url('admin/externalLinksWeb/edit', ['id'=>$field->web_id])}}",//form提交数据的地址  data数据不用带了自动加上了
