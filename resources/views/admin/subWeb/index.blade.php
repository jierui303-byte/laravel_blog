        ...
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				    ...
				    <a class="btn btn-primary radius" data-title="添加子站" onclick="article_add('添加子站','{{url('admin/subWeb/create')}}', '800', '600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加子站</a>
				    <a class="btn btn-primary radius" data-title="添加类型" onclick="article_add('添加类型','{{url('admin/subWebType/create')}}', '800', '600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加类型</a>
				</span>
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <td class="f-14 td-manage">
                            <a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','{{url('admin/subWeb/edit', ['id'=>$v->web_id])}}', '800', '600')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
