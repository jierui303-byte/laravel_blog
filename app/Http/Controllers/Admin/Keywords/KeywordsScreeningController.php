...
use App\Http\Model\Keywords\KeywordsScreening;
...
class KeywordsScreeningController extends CommonController
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->keywordsScreeningData = new KeywordsScreening();
    ...
    public function index(Request $request)
    {
        ...
        $count = count($data);
        return view('admin/keywordsScreening/index', compact('data', 'count'));
    }
    ...
    public function create()
    {
        if($this->request->getMethod() == 'POST'){
            ...
            return view('admin.keywordsScreening.add', compact('data'));
        }
    }
    ...
    public function edit($id)
    {
        if($this->request->getMethod() == 'PUT'){
            ...
            return view('admin.keywordsScreening.edit', compact('data', 'field'));
        }
