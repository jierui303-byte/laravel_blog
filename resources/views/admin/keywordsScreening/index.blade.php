        ...
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				    ...
				    <a class="btn btn-primary radius" data-title="词根分类" onclick="article_add('词根分类','{{url('admin/keywords/create')}}', '1000', '600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 词根分类</a>
				    <a class="btn btn-primary radius" data-title="导入关键词" onclick="article_add('导入关键词','{{url('admin/keywords/create')}}', '1000', '600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 导入关键词</a>
				    <a class="btn btn-primary radius" data-title="采集关键词" onclick="article_add('采集关键词','{{url('admin/keywords/create')}}', '1000', '600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 采集关键词</a>
				    <a class="btn btn-primary radius" data-title="屏蔽词" onclick="article_add('屏蔽词','{{url('admin/keywords/create')}}', '1000', '600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 屏蔽词</a>
				</span>
            ...
            <div class="mt-20 skin-minimal">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    @foreach($data as $v)
                        <tr class="text-c">
                            <td class="zsort" data-id="{{$v->collect_id}}" style="position: relative;">
                                <input name="picCheck" type="checkbox" value="{{$v->collect_id}}">
                            </td>
                            <td>100{{$v->collect_id}}</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            ...
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','{{url('admin/collectRules/edit', ['id'=>$v->collect_id])}}', '1000', '600')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                <a style="text-decoration:none" class="ml-5" onClick="del('{{$v->collect_id}}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
