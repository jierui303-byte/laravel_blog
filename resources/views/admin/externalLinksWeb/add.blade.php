...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="my-form-submit">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">网站域名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="web_domain" name="web_domain">
            </div>
        </div>
        <div class="row cl">
    ...
    $(function(){
        $("#my-form-submit").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    url:"{{url('admin/externalLinksWeb/create')}}",//form提交数据的地址  data数据不用带了自动加上了
