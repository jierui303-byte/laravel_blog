    ...
    <form action="" method="post" class="form form-horizontal" id="my-form-submit">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
					<select name="temp_id" id="temp_id" class="select">
                        ...
                        @foreach($templatesData as $k=>$d)
                            @if($d->temp_id == $field->temp_id)
                                <option value="{{$d->temp_id}}" selected>模板{{$d->temp_math}}__{{$d->temp_name}}</option>
                            @else
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                @if($field->is_open == 1)
                    <div class="radio-box">
                        <input type="radio" value="1" id="is_open-1" name="is_open" checked>
                        <label for="is_open-1">开启</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" value="2" id="is_open-2" name="is_open">
