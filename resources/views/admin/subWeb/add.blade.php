	...
	<form action="" method="post" class="form form-horizontal" id="my-form-submit">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="web_name" name="web_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">网站URL：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="web_url" name="web_url">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="web_ip" name="web_ip">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">百度收录：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="web_baidu_soulu" name="web_baidu_soulu">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">用户名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="jierui303" placeholder="" id="web_user_name" name="web_user_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="123456" placeholder="" id="web_user_pwd" name="web_user_pwd">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">首页友链包月：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="30" placeholder="" id="web_home_link_price" name="web_home_link_price">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">全站友链包月：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="50" placeholder="" id="web_all_link_price" name="web_all_link_price">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	$("#my-form-submit").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				url:"{{url('admin/subWeb/create')}}",//form提交数据的地址  data数据不用带了自动加上了
