(function() {
    var ZBP = function(options, jquery) {
        ...
        // this.userinfo._token = this.cookie.get("_token");
        // this.userinfo.cate_id = this.cookie.get("cate_id");
        // this.userinfo.cate_pid = this.cookie.get("cate_pid");
        // this.userinfo.art_id = this.cookie.get("art_id");
        // this.userinfo.art_title = this.cookie.get("art_title");
        this.plugin.on("userinfo.output", "system", function() {
            ...
            // this.$("#_token").val(this.userinfo._token);
            // this.$("#cate_id").val(this.userinfo.cate_id);
            // this.$("#cate_pid").val(this.userinfo.cate_pid);
            // this.$("#art_id").val(this.userinfo.art_id);
            // this.$("#art_title").val(this.userinfo.art_title);
        });
        this.plugin.on("userinfo.savefromhtml", "system", function() {
            ...
            // this.userinfo._token = this.$("#_token").val();
            // this.userinfo.cate_id = this.$("#cate_id").val();
            // this.userinfo.cate_pid = this.$("#cate_pid").val();
            // this.userinfo.art_id = this.$("#art_id").val();
            // this.userinfo.art_title = this.$("#art_title").val();
            this.userinfo.save()
        });
        this.plugin.on("userinfo.save", "system", function() {
            ...
            // this.cookie.set("_token", this.userinfo._token);
            // this.cookie.set("cate_id", this.userinfo.cate_id);
            // this.cookie.set("cate_pid", this.userinfo.cate_pid);
            // this.cookie.set("art_id", this.userinfo.art_id);
            // this.cookie.set("art_title", this.userinfo.art_title);
        });
    ...
    var initMethods = function(self) {
        ...
        COMMENT.prototype.post = function(formData) {
            ...
            // formData._token = formData._token || $("#_token").val();
            // formData.cate_id = formData.cate_id || $("#cate_id").val();
            // formData.cate_pid = formData.cate_pid || $("#cate_pid").val();
            // formData.art_id = formData.art_id || $("#art_id").val();
            // formData.art_title = formData.art_title || $("#art_title").val();
