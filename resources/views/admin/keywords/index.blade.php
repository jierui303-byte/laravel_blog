        ...
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				    ...
				    <a class="btn btn-primary radius" data-title="添加关键词" onclick="article_add('添加关键词','{{url('admin/keywords/create')}}', '1000', '500')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加关键词</a>
				</span>
            ...
            <div class="mt-20 skin-minimal">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    @foreach($data as $v)
                        <tr class="text-c">
                            <td class="zsort" data-id="{{$v->key_id}}" style="position: relative;">
                                <input name="picCheck" type="checkbox" value="{{$v->key_id}}">
                            </td>
                            <td>100{{$v->key_id}}</td>
                            <td>{{$v->cate_name}}</td>
                            <td>{{$v->key_name}}</td>
                            <td>{{$v->cate_domain}}</td>
                            <td>{{$v->key_search_reault_number}}</td>
                            <td>{{$v->key_pai_ming}}</td>
                            <td>{{$v->update_time}}</td>
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','{{url('admin/keywords/edit', ['id'=>$v->key_id])}}', '1000', '500')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                <a style="text-decoration:none" class="ml-5" onClick="del('{{$v->key_id}}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
