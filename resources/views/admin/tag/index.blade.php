        ...
        <div class="result_wrap">
            ...
            <div class="result_title">
                ...
                <div class="short_wrap">
                    <a href="{{url('admin/tag/create')}}"><i class="fa fa-plus"></i>新增词根</a>
                    <a href="{{url('admin/tag/create')}}"><i class="fa fa-plus"></i>新增长尾词</a>
        ...
        <div class="result_wrap">
            <div class="result_content">
                ...
                <table class="list_tab">
                    <tr>
                        <th class="tc">ID</th>
                        <th class="tc">Tag名称</th>
                        <th class="tc">搜索指数</th>
                        <th class="tc">排名</th>
                        <th class="tc">排名页面</th>
                        <th class="tc">在第几页</th>
                        <th class="tc">所属分类id</th>
                        <th class="tc" width="10%">更新时间</th>
                        <th>操作</th>
                    </tr>
                    @foreach($data as $v)
                    <tr>
