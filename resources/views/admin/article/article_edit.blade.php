	...
	<form action="" method="post" class="form form-horizontal" id="my-form-submit">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$field->art_title}}" placeholder="" id="art_title" name="art_title">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="art_description" id="art_description" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)">{{$field->art_description}}</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$field->art_editor}}" placeholder="" id="art_editor" name="art_editor">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文章来源：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$field->art_laiYuanUrl}}" placeholder="" id="art_laiYuanUrl" name="art_laiYuanUrl">
			</div>
		</div>
		{{--<div class="row cl">--}}
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="radio" class="lg" id="art_status" name="art_status" value="0" @if($field->art_status == 0) checked @endif>是0,代表还是未发布的草稿状态
				<input type="radio" class="lg" id="art_status" name="art_status" value="1" @if($field->art_status == 1) checked @endif>否1,代表文章已经发布
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文章内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" name="art_content" type="text/plain" style="width:100%;height:400px;">{!! $field->art_content !!}</script>
			</div>
		</div>
		<div class="row cl">
...
//			},
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				url:"{{url('admin/article/edit', ['id'=>$field->art_id])}}",//form提交数据的地址  data数据不用带了自动加上了
