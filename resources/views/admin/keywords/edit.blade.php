    ...
    <form action="" method="post" class="form form-horizontal" id="my-form-submit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <select name="cate_pid" id="cate_pid" class="select" disabled>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$field->key_name}}" placeholder="" id="key_name" name="key_name">
            </div>
        </div>
        <div class="row cl">
    ...
    $(function(){
        $("#my-form-submit").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    url:"{{url('admin/keywords/edit', ['id'=>$field->key_id])}}",//form提交数据的地址  data数据不用带了自动加上了
