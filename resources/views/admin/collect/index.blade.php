...
<title>采集任务 - 采集管理 - H-ui.admin v3.0</title>
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加规则" onclick="article_add('添加规则','{{url('admin/collectRules/create')}}', '1000', '600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加规则</a>
				</span>
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    @foreach($data as $v)
                        <tr class="text-c">
                            ...
                            <td>{{$v->collect_list_url}}</td>
                            <td>
                                <div class="switch size-MINI" data-on="success" data-off="warning" data-id="{{$v->collect_id}}">
                                    @if($v->collect_is_open == 1)
    ...
    $(function(){
        $('.switch').on('switch-change', function (e, data) {
            ...
            if(value){
                ...
                $.ajax({
                    type: "post",
                    url: "{{url('admin/collectRules/edit_collect_is_open')}}",
                    data:{
                        _token : "{{ csrf_token() }}",
                        _method : "PUT",
                        collect_is_open : 1,
