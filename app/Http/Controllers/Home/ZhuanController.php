...
class ZhuanController extends CommonController
{
    ...
    public function index()
    {
        ...
        return view('zhuan.zhuanti', compact('pics', 'data', 'links', 'topData', 'twoData', 'hotArticle', 'topTwoNav', 'suijiArticleList', 'yuanChuang', 'zhuanzhai', 'phps', 'seos'));
    }
