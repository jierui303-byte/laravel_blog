    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加友链" onclick="article_add('添加友链','{{url('admin/links/create')}}', '800', '500')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加友链</a>
				</span>
            ...
            <div class="mt-20 skin-minimal">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    @foreach($data as $v)
                        <tr class="text-c">
                            <td class="zsort" data-id="{{$v->link_id}}" style="position: relative;">
                                <input name="picCheck" type="checkbox" value="{{$v->link_id}}">
                            </td>
                            <td>100{{$v->link_id}}</td>
                            <td>
                            ...
                            <td>{{$v->link_url}}</td>
                            <td>在线、下线</td>
                            <td>{{$v->link_end_time}}</td>
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5" onClick="article_edit('友链编辑','{{url('admin/links/edit', ['id'=>$v->link_id])}}', '800', '500')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                <a style="text-decoration:none" class="ml-5" onClick="del('{{$v->link_id}}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
...
//        layer.full(index);
    ...
    /*单条删除*/
    function del(dataId) {
        var postUrl = '{{url('admin/links/del')}}/'+dataId;
    ...
    /*多条删除*/
    function all_del(){
        var postUrl = "{{url('admin/links/del_all')}}";
        var str = '';
        $(".zsort").each(function(){
