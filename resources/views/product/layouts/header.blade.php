...
<head>
	...
	nav>ul>li>ul li:hover>a{background:#535350;text-decoration:none;}
        ...
        #main{width:90%;margin:0 auto;background:red;}
        .pin{width:100%;margin:0 auto;padding:10px;box-sizing: border-box;border:1px solid #fff;background:orange;}
        .box{width:30%;float:left;overflow: hidden;padding:9px;margin:10px;border:1px solid #ccc;opacity: .6;transition:all 1s linear;}
...
<nav>
    <ul>
        <li><a href="http://123.56.247.220/">返回首页</a></li>
	<li><a href="http://123.56.247.220/special">CSS特效练习</a></li>
        <li><a href="http://123.56.247.220/JSspecial">JS特效练习</a></li>
	<li><a href="http://123.56.247.220/AVspecial">音/视频特效练习</a></li>
	<li><a href="http://123.56.247.220/JQueryspecial">特效练习</a></li>
	<!--<li><a href="http://123.56.247.220/">Canvas特效练习</a></li>
	<li><a href="http://123.56.247.220/">Canvas特效练习</a></li>-->
        <li>
		<a href="http://123.56.247.220/">后端语言</a>
		<ul>
			<li><a href="#">PHP</a></li>
        ...
        <li>
		<a href="http://123.56.247.220/">数据库</a>
		<ul>
        ...
        <li>
		<a href="http://123.56.247.220/">web前端</a>
		<ul>
			<li><a href="#">CSS3</a></li>
        ...
        <li>
		<a href="http://123.56.247.220/cate/3">Node</a>
		 <ul>
	...
	<li>
		<a href="http://123.56.247.220/">Linux</a>
		<ul>
			<li><a href="#">Lamp</a></li>
			<li><a href="#">Lnmp</a></li>
		</ul>
