    ...
    <form action="{{url('admin/caiji')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="caiji_name" value="{{$field->caiji_name}}">
            ...
            <tr>
                ...
                <td>
                    @if ($field->caiji_bianm == 0)
                        <input type="radio" name="caiji_bianma" checked value="0">UTF-8
                        <input type="radio" name="caiji_bianma" value="1">GBK2312
                        @else
                        <input type="radio" name="caiji_bianma" value="0">UTF-8
                        <input type="radio" name="caiji_bianma" checked value="1">GBK2312
                    @endif
            ...
            <tr>
                <th>列表URL地址：</th>
                <td>
                    <input type="text" class="lg" name="caiji_list_url" value="{{$field->caiji_list_url}}">
                </td>
                {{--<td>--}}
                {{--模式：--}}
                {{--<select name="cate_pid">--}}
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" value="{{$field->caiji_title_jquery}}" name="caiji_title_jquery" placeholder="#newsContent01>li>a">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" value="{{$field->caiji_attr_jquery}}" name="caiji_attr_jquery" placeholder="text(),content ,texts(),attrs('href'),src,alt"><br/>
                    <p>text():获取元素内的纯文本</p>
            ...
            <tr>
                <th>文章内容选择器：</th>
                <td>
                    <input type="text" class="lg" value="{{$field->caiji_content_jquery}}" name="caiji_content_jquery" placeholder=".bd>#Cnt-Main-Article-QQ[bosszone=content]">
                </td>
            </tr>
            <tr>
                <th>是否显示：</th>
                <td>
                    @if ($field->caiji_status == 0)
                        <input type="radio" class="lg" value="1" name="caiji_status" >开启
                        <input type="radio" class="lg" value="0" checked name="caiji_status" >关闭
                    @else
