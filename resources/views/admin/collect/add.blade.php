    ...
    <form action="" method="post" class="form form-horizontal" id="my-form-submit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="自定义采集规则名字" id="collect_name" name="collect_name">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="http://jierui303.com/list_@.html" id="collect_list_url" name="collect_list_url">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl" id="collect_page_total_div">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="填写页码，数字，默认从第一页采集" id="collect_page_total" name="collect_page_total">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">列表URL选择器：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="#contents .main .article-content .artlist dt>a" id="collect_url_jquery" name="collect_url_jquery">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="title" id="collect_title_jquery" name="collect_title_jquery">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">文章内容选择器：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder=".bd>#article_content" id="collect_content_jquery" name="collect_content_jquery">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">内容过滤选择器：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="-a 代表去除a标签  a代表去除a链接保留文字内容" id="collect_content_del_jquery" name="collect_content_del_jquery">
            </div>
        </div>
        <div class="row cl">
    ...
    $(function(){
        ...
        $("#my-form-submit").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    url:"{{url('admin/collectRules/create')}}",//form提交数据的地址  data数据不用带了自动加上了
    ...
    function collect_url_test() {
        ...
        $.ajax({
            ...
            data:{
                ...
                collect_url_attr_id : $('#collect_url_attr_id').val(),
