    ...
    <form action="#" method="post">
        <div class="result_wrap">
            ...
            <div class="result_content">
                <form action="" method="">
                    标题：<input type="text" value="" name="keywords">
                    发布时间：<select name="" id="">
                        <option value="">日环食的</option>
                        <option value="">日环食的</option>
                    </select>
                    分类：<select name="" id="">
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">{{date('Y-m-d', $v->art_dingTime)}}</td>
                        @if($v->art_isSouLu == '1')
                            <td class="tc" style="color: red">
                                <a href="http://jierui303.com/a/{{$v->art_id}}">已收录</a>
                            </td>
                        @else
                            <td class="tc">未收录</td>
                        @endif
                        <td class="tc">{{$v->art_souLuDate}}</td>
                        <td class="tc">
