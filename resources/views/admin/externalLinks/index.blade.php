    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加外链URL" onclick="article_add('添加外链URL','{{url('admin/externalLinks/create')}}', '800', '500')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加外链URL</a>
				</span>
